...
#   APP_VERSION         — Version string to embed in Info.plist. Defaults to 0.10.1.
#                         Set by CI for nightly builds (e.g., 0.10.1-nightly.20260512+abc1234).
...
APP_VERSION="${APP_VERSION:-0.10.1}"
