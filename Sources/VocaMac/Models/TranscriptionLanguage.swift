...
struct TranscriptionLanguage: Identifiable, Hashable {
    ...
    static let catalog: [TranscriptionLanguage] = [
        ...
        TranscriptionLanguage(code: "sl", displayName: "Slovenian"),
        TranscriptionLanguage(code: "mk", displayName: "Macedonian"),
        TranscriptionLanguage(code: "et", displayName: "Estonian"),
        TranscriptionLanguage(code: "lv", displayName: "Latvian"),
        TranscriptionLanguage(code: "lt", displayName: "Lithuanian"),
        TranscriptionLanguage(code: "mt", displayName: "Maltese"),
